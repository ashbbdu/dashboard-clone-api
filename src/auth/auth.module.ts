...
@Module({
  imports: [SequelizeModule.forFeature([User , Permissions, Role , UserRoles , RolePermission]) , JwtModule.register({
      global: true,
      // secret: process.env.JWT_SECRET_KEY,
      secret : "lavinstar_vinworld_lsl_inj",
      signOptions: { expiresIn: '3060s' },
    }),
  PermissionsModule , RolesModule , UserRolesModule , RolePermissionModule], // added newly
